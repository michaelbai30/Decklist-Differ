/* CardData.java: Model for a given card */
...
public class CardData {
    ...
    public final List<String> colors; // WUBRG color identity of the card
    public final String colorCategory; // High-level color category
